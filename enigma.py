...
def encode(plaintext, settings = ['I,II,III', 'UKW-B', 'ABC', 'DEF', 'AT BS DE FM IR KN LZ OW PV XY']):
  rotors = tuple(settings[0].split(','))
  reflector = settings[1]
  ringSettings = settings[2]
  ringPositions = settings[3]
  plugboard = settings[4]
